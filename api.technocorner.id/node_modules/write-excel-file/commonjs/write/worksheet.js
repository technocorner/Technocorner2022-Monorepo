...
var _generateMergedCellsDescription = _interopRequireDefault(require("./generateMergedCellsDescription"));
...
function generateWorksheet(data, _ref) {
  ...
  return WORKSHEET_TEMPLATE.replace('{data}', (0, _rows["default"])(data, {
    ...
    schema: schema,
    columns: columns
  })).replace('{mergedCellsDescription}', (0, _generateMergedCellsDescription["default"])(data, {
    schema: schema
  })).replace('{layout}', (0, _layout["default"])({
    sheetId: sheetId,
