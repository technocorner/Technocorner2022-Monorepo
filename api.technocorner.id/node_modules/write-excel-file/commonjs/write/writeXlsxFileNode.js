...
var _rels2 = _interopRequireDefault(require("./statics/rels"));

var _Content_Types = _interopRequireDefault(require("./statics/[Content_Types].xml"));

var _writeXlsxFile2 = require("./writeXlsxFile.common");
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref = _args.length > 1 && _args[1] !== undefined ? _args[1] : {}, filePath = _ref.filePath, sheetName = _ref.sheet, sheetNames = _ref.sheets, schema = _ref.schema, columns = _ref.columns, headerStyle = _ref.headerStyle, fontFamily = _ref.fontFamily, fontSize = _ref.fontSize, orientation = _ref.orientation, stickyRowsCount = _ref.stickyRowsCount, stickyColumnsCount = _ref.stickyColumnsCount, dateFormat = _ref.dateFormat;
            archive = new _archive["default"](filePath);
            _generateSheets = (0, _writeXlsxFile2.generateSheets)({
              data: data,
              sheetName: sheetName,
          ...
          case 14:
            ...
            promises = [writeFile(_path["default"].join(_rels, 'workbook.xml.rels'), (0, _workbookXml["default"])({
              sheets: sheets
            })), writeFile(_path["default"].join(xl, 'workbook.xml'), (0, _workbook["default"])({
              sheets: sheets
          ...
          case 19:
            ...
            archive.append(_Content_Types["default"], '[Content_Types].xml');
